...
public class Tuple5<T1, T2, T3, T4, T5> implements Tuple {
     ...
     * 
     * @param <T6> Type of the first value contained in the {@link Tuple1} that will be appended.
     * @param other An instance of {@link Tuple1} containing the value of type {@code T6} to be appended.
     * @return A {@link Tuple6} containing the values from this instance and the value from {@code other}.
     */
     ...
     * 
     * @param <T6> Type of the first value contained in the {@link Tuple2} that will be appended.
     * @param <T7> Type of the second value contained in the {@link Tuple2} that will be appended.
     * @param other An instance of {@link Tuple2} containing the values of types {@code T6} and {@code T7} to be appended.
     ...
     * 
     * @param <T6> Type of the first value contained in the {@link Tuple3} that will be appended.
     * @param <T7> Type of the second value contained in the {@link Tuple3} that will be appended.
     * @param <T8> Type of the third value contained in the {@link Tuple3} that will be appended.
     * @param other An instance of {@link Tuple3} containing the values of types {@code T6}, {@code T7} and {@code T8} to be appended.
     ...
     * 
     * @param <T6> Type of the first value contained in the {@link Tuple1} that will be prepended.
     * @param other An instance of {@link Tuple1} containing the value of type {@code T6} to be prepended.
     * @return A {@link Tuple6} containing the value from {@code other} and the values from this instance.
     */
     ...
     * 
     * @param <T6> Type of the first value contained in the {@link Tuple2} that will be prepended.
     * @param <T7> Type of the second value contained in the {@link Tuple2} that will be prepended.
     * @param other An instance of {@link Tuple2} containing the values of {@code T6} and {@code T7} to be prepended.
     ...
     * 
     * @param <T6> Type of the first value contained in the {@link Tuple3} that will be prepended.
     * @param <T7> Type of the second value contained in the {@link Tuple3} that will be prepended.
     * @param <T8> Type of the third value contained in the {@link Tuple3} that will be prepended.
     * @param other An instance of {@link Tuple3} containing the values of {@code T6}, {@code T7} and {@code T8} to be prepended.
