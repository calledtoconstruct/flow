...
public class WhenInvokingTryGetLastTest {
    ...
    private final Optional<Long> firstResult = tuple1.tryGetLast(Long.class);
    private final Optional<String> firstResultEmpty = tuple1.tryGetLast(String.class);
    private final Optional<Long> secondResult = tuple2.tryGetLast(Long.class);
    private final Optional<String> secondResultEmpty = tuple2.tryGetLast(String.class);
    private final Optional<Long> thirdResult = tuple3.tryGetLast(Long.class);
    private final Optional<String> thirdResultEmpty = tuple3.tryGetLast(String.class);
    private final Optional<Long> fourthResult = tuple4.tryGetLast(Long.class);
    private final Optional<String> fourthResultEmpty = tuple4.tryGetLast(String.class);
    private final Optional<Long> fifthResult = tuple5.tryGetLast(Long.class);
    private final Optional<String> fifthResultEmpty = tuple5.tryGetLast(String.class);
    private final Optional<Long> sixthResult = tuple6.tryGetLast(Long.class);
    private final Optional<String> sixthResultEmpty = tuple6.tryGetLast(String.class);
    private final Optional<Long> seventhResult = tuple7.tryGetLast(Long.class);
    private final Optional<String> seventhResultEmpty = tuple7.tryGetLast(String.class);
    private final Optional<Long> eighthResult = tuple8.tryGetLast(Long.class);
    private final Optional<String> eighthResultEmpty = tuple8.tryGetLast(String.class);
    ...
    void thatSecondResultIsCorrect() {
        ...
        Assertions.assertEquals(SECOND_VALUE, secondResult.get());
    ...
    void thatThirdResultIsCorrect() {
        ...
        Assertions.assertEquals(THIRD_VALUE, thirdResult.get());
    ...
    void thatFourthResultIsCorrect() {
        ...
        Assertions.assertEquals(FOURTH_VALUE, fourthResult.get());
    ...
    void thatFifthResultIsCorrect() {
        ...
        Assertions.assertEquals(FIFTH_VALUE, fifthResult.get());
    ...
    void thatSixthResultIsCorrect() {
        ...
        Assertions.assertEquals(SIXTH_VALUE, sixthResult.get());
    ...
    void thatSeventhResultIsCorrect() {
        ...
        Assertions.assertEquals(SEVENTH_VALUE, seventhResult.get());
    ...
    void thatEighthResultIsCorrect() {
        ...
        Assertions.assertEquals(EIGHTH_VALUE, eighthResult.get());
