...
class WhenTryingToShiftValuesTest {
    ...
    private final Optional<Tuple> second = first.tryShift();
    private final Optional<Tuple> third = second.isPresent() ? second.get().tryShift() : Optional.empty();
    private final Optional<Tuple> fourth = third.isPresent() ? third.get().tryShift() : Optional.empty();
    private final Optional<Tuple> fifth = fourth.isPresent() ? fourth.get().tryShift() : Optional.empty();
    private final Optional<Tuple> sixth = fifth.isPresent() ? fifth.get().tryShift() : Optional.empty();
    private final Optional<Tuple> seventh = sixth.isPresent() ? sixth.get().tryShift() : Optional.empty();
    private final Optional<Tuple> eighth = seventh.isPresent() ? seventh.get().tryShift() : Optional.empty();
    private final Optional<Tuple> extra = eighth.isPresent() ? eighth.get().tryShift() : Optional.empty();
